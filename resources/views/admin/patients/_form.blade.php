...
<div class="form-group">
    ...
    {!!
    Form::text('first_name',null,['class'=>'form-control','parsley-trigger'=>'change','id'=>'first_name','required','placeholder'=>__('Enter
    First Name')]) !!}
    @error('first_name')
    <span class="invalid-feedback d-block" role="alert">
        <strong>{{ $message }}</strong>
...
<div class="form-group">
    ...
    {!!
    Form::text('last_name',null,['class'=>'form-control','parsley-trigger'=>'change','id'=>'last_name','required','placeholder'=>__('Enter
    Last Name')]) !!}
    @error('last_name')
    <span class="invalid-feedback d-block" role="alert">
        <strong>{{ $message }}</strong>
...
<div class="form-group">
    ...
    {!!
    Form::number('civil_id',null,['class'=>'form-control','parsley-trigger'=>'change','id'=>'civil_id','required','placeholder'=>__('Enter
    Civil Id')]) !!}
    @error('civil_id')
    <span class="invalid-feedback d-block" role="alert">
        <strong>{{ $message }}</strong>
...
<div class="form-group">
    ...
    datepicker','parsley-trigger'=>'change','id'=>'birthdate','parsley-trigger'=>'change',
...
<div class="form-group">
    ...
    {!!
    Form::select('gender',[1=>__("Male"),2=>__("Female")],null,['class'=>'form-control','parsley-trigger'=>'change','id'=>'gender',"data-parsley-type"=>"integer",'required','placeholder'=>__('Select
    Gender')]) !!}
    @error('gender')
    <span class="invalid-feedback d-block" role="alert">
        <strong>{{ $message }}</strong>
...
<div class="form-group">
    ...
    select2','parsley-trigger'=>'change','id'=>'social_security_id','placeholder'=>__('Social Security'),]) !!}
...
<div class="form-group">
    ...
    {!! Form::text('social_security_expired_at',null,['class'=>'form-control
    datepicker','parsley-trigger'=>'change','id'=>'social_security_expired_at','parsley-trigger'=>'change',
...
<div class="form-group">
    ...
    <input id="pass1" name="password" type="password" placeholder="{!! __(" Password") !!}" @if(!isset($patient))
...
<div class="form-group">
    ...
    <input data-parsley-equalto="#pass1" name="password_confirmation" type="password" @if(!isset($patient)) required
        @endif placeholder="{!! __(" Confirm Password") !!}" class="form-control" id="passWord2">
</div>


<div class="form-group">
    <label for="image">{!!__("image") !!}</label>
    <input type="file" name="image" class="dropify" @if(isset($patient))data-default-file="{!! url($patient->img) !!}"
        @endif />
    @error('image')
    <span class="invalid-feedback d-block" role="alert">
        <strong>{{ $message }}</strong>
